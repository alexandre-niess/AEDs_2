...
public class TP02Q05 {
    ...
    public static void main (String args[]) throws Exception{
        ...
        qtde = sc.nextInt();
        Stack<Personagem> stack = new Stack<Personagem>();

        for(int i = 0; i < numEntrada; i++){
            Personagem psg = new Personagem();
            psg.ler(entrada[i]);
            stack.push(psg);
        }
        ...
        for(int i = 0; i < (qtde+1); i++){
            ...
            if(Split[0].equals("I")){
                ...
                System.out.println("(R) " + stack.pop().getNome());
            }
        }
        ...
        // stack.push("elemento1");  //para adicionar um elemento
        //String elementoRemovido = stack.pop();  //para remover um elemento
        //String elementoNoTopo = stack.peek();  //para pegar o elemento do topo
        //boolean pilhaVazia = stack.isEmpty();  //para verificar se a pilha está vazia
        //int tamanhoPilha = stack.size();  //para verificar o tamanho da pilha
